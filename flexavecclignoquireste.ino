...
//on peut activer en levant le doigt puis baisser le doigt et le désactiver en levant le doigt à nouveau
...
void loop() {
  ...
  if (valeur_flexgauche>340 and valeur_flexdroite<690 and valeur_flexgauche>ancienne_val_gauche){ //si on veut aller à gauche
  ...
  else if (valeur_flexgauche<340 and valeur_flexdroite>690 and valeur_flexdroite>ancienne_val_droite){ //si on veut aller à droite
    delay(800); //pour être sûr qu'on ne fait pas un geste non voulu
    etatgauche=1-etatgauche;}
    
  else if (valeur_flexgauche<230 and valeur_flexdroite<630){ //si on freine
